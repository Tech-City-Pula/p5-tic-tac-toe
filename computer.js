...
function calculateComputerMove() {
  let xPosition = calculateXPosition(random(0, CANVAS_SIZE));
  let yPosition = calculateYPosition(random(0, CANVAS_SIZE));

  while (gameState[xPosition][yPosition] !== '-') {
    xPosition = calculateXPosition(random(0, CANVAS_SIZE));
    yPosition = calculateYPosition(random(0, CANVAS_SIZE));
  }
